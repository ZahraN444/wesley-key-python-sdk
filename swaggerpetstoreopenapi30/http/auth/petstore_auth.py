...
from swaggerpetstoreopenapi30.models.oauth_token import (
    OauthToken,
)
...
class PetstoreAuthCredentials:
    ...
    def __init__(self, oauth_client_id, oauth_redirect_uri, oauth_token=None,
                 oauth_scopes=None):
        """
    ...
    def clone_with(self, oauth_client_id=None, oauth_redirect_uri=None,
    ...
    def from_environment(cls):
        ...
        oauth_client_id = os.getenv(
            "PETSTORE_AUTH_OAUTH_CLIENT_ID",
            None,
        )
        oauth_redirect_uri = os.getenv(
            "PETSTORE_AUTH_OAUTH_REDIRECT_URI",
            None,
        )
        oauth_scopes = os.getenv(
            "PETSTORE_AUTH_OAUTH_SCOPES",
            None,
        )
