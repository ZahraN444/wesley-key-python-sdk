...
from swaggerpetstoreopenapi30.http.proxy_settings import (
    ProxySettings,
)
from swaggerpetstoreopenapi30.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    def petstore_auth_credentials(self):
        """Return current petstore_auth_credentials."""
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 environment=Environment.PRODUCTION, petstore_auth_credentials=None,
    ...
    def clone_with(self, http_client_instance=None,
        ...
        petstore_auth_credentials =\
            (petstore_auth_credentials
            or self.petstore_auth_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            petstore_auth_credentials=PetstoreAuthCredentials.from_environment(),
