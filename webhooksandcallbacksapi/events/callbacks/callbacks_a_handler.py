...
class CallbacksAHandler:
    ...
    def verify_and_parse_event(self, request: Request) -> CallbacksAEventType:
        """
         Verify the request signature and parse the event.

        :return: PaymentCallback, FulfillmentCallback for successful parsing;
                 SignatureVerificationFailure when signature fails; UnknownEvent for
                 unknown events.
        :rtype: Union[PaymentCallback, FulfillmentCallback,
