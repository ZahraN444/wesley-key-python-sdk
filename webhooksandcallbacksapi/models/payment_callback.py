...
from webhooksandcallbacksapi.models.payment_status import (
    PaymentStatus,
)
...
class PaymentCallback(object):
    ...
    Attributes:
        ...
        payment_status (PaymentStatus): The model property of type PaymentStatus.
