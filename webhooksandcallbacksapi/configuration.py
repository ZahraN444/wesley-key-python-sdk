...
from webhooksandcallbacksapi.http.proxy_settings import (
    ProxySettings,
)
from webhooksandcallbacksapi.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 timeout=50, max_retries=0, backoff_factor=2, retry_statuses=None,
