...
from webhooksandcallbacksapi.models.delivery_details import (
    DeliveryDetails,
)
...
class UnionTypeLookUp:
    ...
    _templates: ClassVar[dict[str, Callable]] = {
        ...
        "RootLevelOneOfPrimitiveEventRootLevelPrimitiveOneOfBody": lambda: OneOf(
            [
                LeafType(RootLevelPrimitiveOneOfEventRequest),
                LeafType(int),
                LeafType(RootLevelPrimitiveOneOfEventRequest1,
                         Context.create(
                             is_array=True,
                         )),
                LeafType(int,
        ...
        "FulfillmentCallbackDeliveryDetails": lambda: OneOf(
            [
                LeafType(str),
                LeafType(DeliveryDetails),
            ],
            Context.create(
               is_optional=True,
            ),
        ),
        "OrderCreatedEventDeliveryDetails": lambda: OneOf(
            [
                LeafType(str),
                LeafType(DeliveryDetails),
            ],
