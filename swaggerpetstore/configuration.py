...
from swaggerpetstore.http.proxy_settings import (
    ProxySettings,
)
...
class Configuration(HttpClientConfiguration):
    ...
    def http_basic_credentials(self):
        """Return current http_basic_credentials."""
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        test_header = os.getenv("TEST_HEADER", "TestHeaderDefaultValue")
        ...
        default_config = cls(
            ...
            http_basic_credentials=HttpBasicCredentials.from_environment(),
