...
class PetstoreAuth(HeaderAuth):
    ...
    def get_authorization_url(self, state=None, additional_params=None):
        ...
        """
        auth_url = self._config.get_base_uri(Server.DEFAULT)
        auth_url += '/authorize'
        query_params = {
            'response_type': 'code',
...
class PetstoreAuthCredentials:
    ...
    def from_environment(cls):
        o_auth_client_id = os.getenv('PETSTORE_AUTH_O_AUTH_CLIENT_ID', None)
        o_auth_redirect_uri = os.getenv('PETSTORE_AUTH_O_AUTH_REDIRECT_URI', None)
        o_auth_scopes = os.getenv('PETSTORE_AUTH_O_AUTH_SCOPES', None)
