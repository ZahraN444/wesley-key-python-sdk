...
This event's request payload is of type [RootLevelPrimitiveOneOfEventRequest | int | List[RootLevelPrimitiveOneOfEventRequest1] | List[int]](../../../../doc/models/containers/root-level-one-of-primitive-event-root-level-primitive-one-of-body.md).
