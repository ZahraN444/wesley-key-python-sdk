...
from cypresstestapi.configuration import Configuration, Environment
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = CypresstestapiClient(config=cls.config)

    @staticmethod
    def create_configuration():
        environment = os.getenv('CYPRESSTESTAPI_ENVIRONMENT')
        default_host = os.getenv('CYPRESSTESTAPI_DEFAULT_HOST')
